...
const Footer = () => {
  return (
    <footer className="bg-[#003B73] text-white">
          ...
          <div>
            ...
            <ul className="space-y-4 font-open">
              <li className="flex items-center">
                <Mail className="mr-2 text-[#F5A623]" size={18} />
              ...
              <li className="flex items-center">
                <Linkedin className="mr-2 text-[#F5A623]" size={18} />
              ...
              <li className="flex items-start">
                <MapPin className="mr-2 text-[#F5A623] mt-1" size={18} />
