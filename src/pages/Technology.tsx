    ...
    <div className="min-h-screen">
        ...
        <div className="container px-4">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2">
              ...
              <h3 className="text-xl font-semibold mb-4 font-montserrat">Power Input Options:</h3>
      ...
      <section className="py-20 bg-white">
        <div className="container px-4">
          ...
          <div className="bg-[#DEDEDE] p-8 rounded-lg shadow-lg mb-10">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="col-span-2">
                <h3 className="text-2xl font-semibold mb-4 font-montserrat">The Challenge</h3>
                <p className="text-gray-600 mb-6 font-open">
                ...
                <h3 className="text-2xl font-semibold mb-4 font-montserrat">Our Solution</h3>
